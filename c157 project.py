...
img = ImageTk.PhotoImage(Image.open("button.jfif"))
abra = ImageTk.PhotoImage(Image.open("abra.png"))
bulbasour = ImageTk.PhotoImage(Image.open("bulbasour.jpg"))
charmender = ImageTk.PhotoImage(Image.open("charmender.png"))
iyvasour = ImageTk.PhotoImage(Image.open("ivyasaur.jfif"))
jigglypuff = ImageTk.PhotoImage(Image.open("jigglypuff.png"))
kadabra = ImageTk.PhotoImage(Image.open("kadabra.png"))
meowth = ImageTk.PhotoImage(Image.open("meowth.png"))
nidoking = ImageTk.PhotoImage(Image.open("nidoking.png"))
paras = ImageTk.PhotoImage(Image.open("paras.png"))
persion = ImageTk.PhotoImage(Image.open("persian.png"))
